...
description: Turn a decision you can't fully answer into a questionnaire for someone else to fill in. En français : le questionnaire à envoyer au client (ou à un tiers) pour une décision que lui seul peut trancher.
